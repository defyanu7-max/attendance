										...
										<div class="card-body px-0">
											...
											<div class="dlab-scroll px-3 mt-3 height300">
												<ul class="d-flex align-items-center mb-3">
													<li>
														<img src="{{asset('images/avatar/1.jpg')}}" class="avatar avatar-sm" alt="">
												...
												<ul class="d-flex align-items-center mb-3">
													<li>
														<img src="{{asset('images/avatar/2.jpg')}}" class="avatar avatar-sm" alt="">
												...
												<ul class="d-flex align-items-center mb-3">
													<li>
														<img src="{{asset('images/avatar/4.jpg')}}" class="avatar avatar-sm" alt="">
														<a href="javascript:void(0);" class="ms-2">Benjamin</a>
												...
												<ul class="d-flex align-items-center mb-3">
													<li>
														<img src="{{asset('images/avatar/3.jpg')}}" class="avatar avatar-sm" alt="">
														<a href="javascript:void(0);" class="ms-2">Benjamin</a>
									...
									<div class="dropdown-menu dropdown-menu-end pb-0" style="">
										<div class="card mb-0">
											...
											<div class="card-body p-3">
												...
												<a href="{{ url('chat') }}" class="dropdown-item ai-icon ">
													<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1" class="svg-main-icon">
														<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
															<rect x="0" y="0" width="24" height="24"/>
											...
											<div class="card-footer text-center p-3">
												<a href="{{ url('page-login') }}" class="dropdown-item ai-icon btn btn-primary light">
