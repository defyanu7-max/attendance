							...
							<div class="card contact_list text-center">
								<div class="card-body">
									<div class="user-content">
										<div class="user-info">
											<div class="user-img">
												<img src="{{ asset('images/contacts/1.jpg') }}" alt="" class="avatar avatar-xl">
											</div>
									...
									<div class="d-flex align-items-center">
										<a href="{{url('app-profile')}}" class="btn  btn-primary btn-sm w-50 me-2"><i class="fa-solid fa-user me-2"></i>Profile</a>
										<a href="{{url('chat')}}" class="btn  btn-light btn-sm w-50"><i class="fa-sharp fa-regular fa-envelope me-2"></i>Chat</a>
									</div>
								</div>
							</div>
						</div>
							...
							<div class="card contact_list text-center">
								 <div class="card-body">
									<div class="user-content">
										<div class="user-info">
											<div class="user-img">
												<img src="{{ asset('images/contacts/2.jpg') }}" alt="" class="avatar avatar-xl">
											</div>
											<div class="user-details">
												<h4 class="user-name mb-0">Dimitres Viga</h4>
												<p>Teacher</p>
							...
							<div class="card contact_list text-center">
								<div class="card-body">
									<div class="user-content">
										<div class="user-info">
											<div class="user-img">
												<img src="{{ asset('images/contacts/3.jpg') }}" alt="" class="avatar avatar-xl">
											</div>
											<div class="user-details">
												<h4 class="user-name mb-0">Dimitres Viga</h4>
												<p>Teacher</p>
							...
							<div class="card contact_list text-center">
							  <div class="card-body">
									<div class="user-content">
										<div class="user-info">
											<div class="user-img">
												<img src="{{ asset('images/contacts/4.jpg') }}" alt="" class="avatar avatar-xl">
											</div>
											<div class="user-details">
												<h4 class="user-name mb-0">Dimitres Viga</h4>
												<p>Teacher</p>
							...
							<div class="card contact_list text-center">
								<div class="card-body">
									<div class="user-content">
										<div class="user-info">
											<div class="user-img">
												<img src="{{ asset('images/contacts/5.jpg') }}" alt="" class="avatar avatar-xl">
											</div>
											<div class="user-details">
												<h4 class="user-name mb-0">Dimitres Viga</h4>
												<p>Teacher</p>
							...
							<div class="card contact_list text-center">
							  <div class="card-body">
									<div class="user-content">
										<div class="user-info">
											<div class="user-img">
												<img src="{{ asset('images/contacts/6.jpg') }}" alt="" class="avatar avatar-xl">
											</div>
											<div class="user-details">
												<h4 class="user-name mb-0">Dimitres Viga</h4>
												<p>Teacher</p>
							...
							<div class="card contact_list text-center">
							  <div class="card-body">
									<div class="user-content">
										<div class="user-info">
											<div class="user-img">
												<img src="{{ asset('images/contacts/7.jpg') }}" alt="" class="avatar avatar-xl">
											</div>
											<div class="user-details">
												<h4 class="user-name mb-0">Dimitres Viga</h4>
												<p>Teacher</p>
							...
							<div class="card contact_list text-center">
							  <div class="card-body">
									<div class="user-content">
										<div class="user-info">
											<div class="user-img">
												<img src="{{ asset('images/contacts/8.jpg') }}" alt="" class="avatar avatar-xl">
											</div>
											<div class="user-details">
												<h4 class="user-name mb-0">Dimitres Viga</h4>
												<p>Teacher</p>
							...
							<div class="card contact_list text-center">
							   <div class="card-body">
									<div class="user-content">
										<div class="user-info">
											<div class="user-img">
												<img src="{{ asset('images/contacts/9.jpg') }}" alt="" class="avatar avatar-xl">
											</div>
											<div class="user-details">
												<h4 class="user-name mb-0">Dimitres Viga</h4>
												<p>Teacher</p>
							...
							<div class="card contact_list text-center">
								<div class="card-body">
									<div class="user-content">
										<div class="user-info">
											<div class="user-img">
												<img src="{{ asset('images/contacts/10.jpg') }}" alt="" class="avatar avatar-xl">
											</div>
											<div class="user-details">
												<h4 class="user-name mb-0">Dimitres Viga</h4>
												<p>Teacher</p>
							...
							<div class="card contact_list text-center">
							   <div class="card-body">
									<div class="user-content">
										<div class="user-info">
											<div class="user-img">
												<img src="{{ asset('images/contacts/11.jpg') }}" alt="" class="avatar avatar-xl">
											</div>
											<div class="user-details">
												<h4 class="user-name mb-0">Dimitres Viga</h4>
												<p>Teacher</p>
							...
							<div class="card contact_list text-center">
							  <div class="card-body">
									<div class="user-content">
										<div class="user-info">
											<div class="user-img">
												<img src="{{ asset('images/contacts/12.jpg') }}" alt="" class="avatar avatar-xl">
											</div>
											<div class="user-details">
												<h4 class="user-name mb-0">Dimitres Viga</h4>
												<p>Teacher</p>
