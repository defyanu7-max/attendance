							...
							<div class="row align-items-center">
								<div class="col-sm-9"> 
									<div class="brand-logo mb-3">
										<img class="logo-abbr me-2 dark-logo" width="150" src="{{ asset('images/logo-full.png') }}" alt="">
										<img class="logo-abbr me-2 light-logo" width="150" src="{{ asset('images/logo-white.png') }}" alt="">
									</div>
