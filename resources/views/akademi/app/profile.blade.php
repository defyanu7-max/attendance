								...
								<div id="my-posts" class="tab-pane fade active show">
									<div class="my-post-content pt-3">
										...
										<div class="profile-uoloaded-post border-bottom-1 pb-5">
											...
											<a class="post-title" href="{{ url('post-details')}}"><h3 class="text-black">How To Get (A) Fabulous EDUCATION On A Tight Budget</h3></a>
										...
										<div class="profile-uoloaded-post border-bottom-1 pb-5">
											...
											<a class="post-title" href="{{ url('post-details')}}"><h3 class="text-black">How To Win Clients And Influence Markets with EDUCATION</h3></a>
										...
										<div class="profile-uoloaded-post pb-3">
											<img src="{{ asset('images/profile/8.jpg') }}" alt="" class="img-fluid w-100 rounded">
											<a class="post-title" href="{{ url('post-details')}}"><h3 class="text-black">What Can Instagramm Teach You About EDUCATION</h3></a>
